...
import {createGroup, createPerson, updateGroup, updatePerson} from '../actions'
...
export const StyledModal: React.FC<Props> = ({show, handleClose, isUpdate, type, initialValues}) => {
		...
		return (
			<Modal show={show} onHide={handleClose}>
				<Modal.Header closeButton>
					<Modal.Title>{`${isUpdate ? 'Update' : 'Create'} ${type === 'group' ? 'Group' : 'Person'}`}</Modal.Title>
				</Modal.Header>
				<MyForm 
					isGroup={type === 'group'}
